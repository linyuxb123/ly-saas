package com.ly.saas.qiu.api.controller;

import com.ly.saas.qiu.core.constant.Constants;
import com.ly.saas.qiu.core.entity.Dept;
import com.ly.saas.qiu.service.DeptService;
 ...
 * 部门控制器
 */
@RestController("qiuDeptController")
@RequestMapping(Constants.API_PREFIX + "/dept")
public class DeptController {

    @Autowired
    @Qualifier("qiuDeptService")
