package com.ly.saas.chun.api.controller;

import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.ly.saas.chun.core.constant.Constants;
import com.ly.saas.chun.core.entity.User;
import com.ly.saas.chun.service.UserService;
 ...
 */
@Slf4j
@RestController("chunUserController")
@RequestMapping(Constants.API_PREFIX + "/user")
public class UserController {

    @Resource(name = "chunUserService")
